...
Start-Transcript -Path "C:\PS\Transcripts\CreateVswitch-esxi-05.txt"

    $HostName = "10.20.20.25"
   
    $vMotionIP = "10.10.20.25"
    $vMotionvlan = "20"
    $vcHAvlan = "40"
    $Lanvlan = "50"

    $iSCSIIPA = "10.10.99.22"
    $iSCSIIPB = "10.10.99.25"
    $MTU = "1500"
    $SubnetMask = "255.255.255.0"

    $iSCSITarget = "10.10.99.1:3260"
    $HostIQN = "iqn.1998-01.com.vmware:esxi05"
    $iSCSIvlanA = "99"
    $iSCSIvlanB = "99"
    $iSCSIAvmnic = "vmnic4"
    $iSCSIBvmnic = "vmnic5"
